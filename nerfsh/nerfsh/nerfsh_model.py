...
# nerfsh model based on modification of the nerfacto model.
...
from nerfsh.nerfsh_field import nerfshField


@dataclass
class nerfshModelConfig(ModelConfig):
    """Template Model Configuration.

    Add your custom model config parameters here.
    """

    _target: Type = field(default_factory=lambda: nerfshModel)
...
class nerfshModel(Model):
    """Template Model."""

    config: nerfshModelConfig
