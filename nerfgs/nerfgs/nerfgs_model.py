...
# nerfgs model based on modification of the nerfacto model.
...
from nerfgs.nerfgs_field import nerfgsField


@dataclass
class nerfgsModelConfig(ModelConfig):
